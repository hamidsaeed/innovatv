...
$id = $user_id = $name = $location = $description = $base_rate = "";
$edit_mode = false;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                ...
                                <form method="post" action="update_equipment.php" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Equipment Name" value="<?php echo $name; ?>" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="equipment.php" class="btn btn-default float-right">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
