...
$id = $title = $image = $author = $date = $content =  "";
$edit_mode = false;
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Blogs</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Blogs</h3>
                                </div>
                                <form method="post" action="update_blog.php" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="file" class="form-control" id="image" name="image" placeholder="Image" value="<?php echo $image; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row"style="margin-bottom: 20px">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="blog.php" class="btn btn-default float-right">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
