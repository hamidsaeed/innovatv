...
$id = $firstname = $lastname = $email = $bio = $profile = $phone = $adminnot = "";
$edit_mode = false;
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Users</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Users</h3>
                                </div>
                                <form method="post" action="update_users.php" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="file" class="form-control" id="profile" name="profile" placeholder="Profile" value="<?php echo $profile; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="admin/not" class="col-sm-2 col-form-label">Admin or not an Admin</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="admin/not" name="admin/not" placeholder="admin/not" value="<?php echo $adminnot; ?>" required>
                                            </div>
                                        </div>
