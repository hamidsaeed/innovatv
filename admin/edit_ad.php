...
$id = $title = $content = $advertiser_id = $start_date = $end_date = $status = "";
$edit_mode = false;
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Advertisement</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-name"><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Advertisement</h3>
                                </div>
                                <form method="post" action="update_ad.php" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            <label for="advertiser_id" class="col-sm-2 col-form-label">Advertisers</label>
                                            <div class="col-sm-10">
                                                <select class="form-control select2bs4" style="width: 100%;" id="advertiser_id" name="advertiser_id">
                                                    <option value="0">-- Select Advertisers--</option>
                                                    <?php 
                                                    $userQuery = "SELECT id, name FROM advertiser";
                                                    $userResult = $conn->query($userQuery);
                                                    if ($userResult->num_rows > 0) {
                                                        while($users = $userResult->fetch_assoc()){ ?>
                                                            <option value="<?php echo $users['id']; ?>" <?php echo ($users['id'] == $advertiser_id) ? 'selected="selected"' : ''; ?>>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="ad.php" class="btn btn-default float-right">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
