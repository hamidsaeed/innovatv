...
$id = $name = $description = $star_id = $base_rate = $stock = "";
$edit_mode = false;
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Merchandise</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-name"><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Merchandise</h3>
                                </div>
                                <form method="post" action="update_merchandise.php" class="form-horizontal">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            <label for="name" class="col-sm-2 col-form-label">Merchandise Name</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Merchandise" value="<?php echo $name; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row"style="margin-bottom: 20px">
                                        ...
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            <label for="base_rate" class="col-sm-2 col-form-label">Base Rate</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="base_rate" name="base_rate" placeholder="Base Rate" value="<?php echo $base_rate; ?>" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="merchandise.php" class="btn btn-default float-right">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
