        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Company</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo $edit_mode ? 'Edit' : 'Add'; ?> Company</h3>
                                </div>
                                <form method="post" action="update_company.php" class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row"style="margin-bottom: 20px">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="industry" name="industry" placeholder="Industry" value="<?php echo $industry; ?>" required>
                                            </div>
                                        </div>
