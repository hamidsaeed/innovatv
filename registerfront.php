...
<!-- Mirrored from holaa.codexshaper.com/html/registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 12:15:39 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Register-InnovaTv</title>
        ...
        <div class="breadcrumb-area position-relative">
            <div class="position-absolute top-50 start-50 translate-middle text-center">
                ...
                <ul class="breadcrumb-area--list">
                    ...
                    <li class="breadcrumb-area--item d-inline-block">Registration</li>
                </ul>
            </div>
        </div>
        <!-- End Breadcrumb Area -->
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="registration-wrap holaa-form-wrapper">
                            ...
                            <form action="submit_registerfront.php" method="POST">
                                <div class="row">
                                    <div class="col-md-6">
