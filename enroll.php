...
<!-- Mirrored from holaa.codexshaper.com/html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Jul 2024 12:15:49 GMT -->
<head>
        <meta charset="utf-8">
...
<body>
    ...
    <div class="breadcrumb-area position-relative">
        <div class="position-absolute top-50 start-50 translate-middle text-center">
            <h1 class="page-name text-uppercase lh-1 mb-0">Enroll</h1>
            <ul class="breadcrumb-area--list">
                ...
                <li class="breadcrumb-area--item d-inline-block">Enroll</li>
            </ul>
        </div>
    </div>
    <!-- End Breadcrumb Area -->
     ...
     ?>
        <div class="container pt-80">
            <div class="contact-form-wrap holaa-form-wrapper">
                <h5 class="inner-small-title mb-lg-5 mb-4  text-md-center">Please fill the form for the Internship Program</h5>
                <form action="#">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <labe class="single-input-field style-border">
                                <span>Email</span>
    ...
    <label class="form-label">
        <span>Please select the name of the Internship Program</span>
        <select name="internship" id="internship" class="form-select mt-2">
            <option value="1">React</option>
            <option value="2">Javascript</option>
            <option value="3">HTML 5 & CSS 3</option>
            <option value="4">Angular</option>
            <option value="5">Ruby on Rails</option>
            <option value="6">Laravel</option>
                        ...
                        <div class="col-12">
                            <labe class="single-input-field style-border">
                                <span>Reason for Selecting</span>
